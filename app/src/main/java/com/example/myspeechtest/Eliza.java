...
public class Eliza {
    ...
    private static final String[] CONVERSATION_KEYWORDS = {"CAN YOU", "CAN I", "YOU ARE", "YOURE", "I DONT", "I FEEL", "WHY DONT YOU", "WHY CANT I",
    ...
    private static final String[] CONVERSATION_KEYWORDS_DE = {"KANNST DU", "KANN ICH", "DU BIST", "DUBIST", "I DONT", "ICH FÜHLE", "WARUM NICHT DU", "WARUM KANN ICH NICHT",
    ...
    private static String[] WORDS_TO_REPLACE_DE = {"BIST","BIN","WAREN","WAR","DU","ICH","DEIN","MEIN",
            "ICH HABE","DU HAST","ICH BIN","DU BIST", "DIR", "MIR"};

    private static String[] QUESTIONS = {
            "GLAUBST DU NICHT, DASS ICH DAS KANN.", "VIELLEICHT WÄRST DU GERN IN DER LAGE DAZU.",
            "DU MÖCHTEST, DASS ICH IN DER LAGE BIN ZU*", "VIELLEICHT WILLST DU NICHT*",
            "MÖCHTEST DU IN DER LAGE SEIN ZU*", "WARUM DENKST DU ICH BIN*",
            "FREUT ES DICH ZU GLAUBEN DASS ICH*BIN", "VIELLEICHT MÖCHTEST DU*SEIN",
            "WÜNSCHT DU DIR MANCHMAL DU WÄRST*", "DON'T YOU REALLY*", "WHY DON'T YOU*",
